...
fan_id00_abnormal = pd.read_csv("/Listen_repo/fan_csv/fan_id00_abnormal")
fan_id00_normal = pd.read_csv("/Listen_repo/fan_csv/fan_id00_normal")
fan_id02_abnormal = pd.read_csv("/Listen_repo/fan_csv/fan_id02_abnormal")
fan_id02_normal = pd.read_csv("/Listen_repo/fan_csv/fan_id02_normal")
fan_id04_abnormal = pd.read_csv("/Listen_repo/fan_csv/fan_id04_abnormal")
fan_id04_normal = pd.read_csv("/Listen_repo/fan_csv/fan_id04_normal")
fan_id06_abnormal = pd.read_csv("/Listen_repo/fan_csv/fan_id06_abnormal")
fan_id06_normal = pd.read_csv("/Listen_repo/fan_csv/fan_id06_normal")
...
valve_id_00_abnormal = pd.read_csv("C:\\Users\\sanid\\PycharmProjects\\Listen\\Listen_repo\\valve_csv\\valve_id_00_abnormal")
valve_id_00_normal = pd.read_csv("C:\\Users\\sanid\\PycharmProjects\\Listen\\Listen_repo\\valve_csv\\valve_id_00_normal")
valve_id_02_abnormal = pd.read_csv("C:\\Users\\sanid\\PycharmProjects\\Listen\\Listen_repo\\valve_csv\\valve_id_02_abnormal")
valve_id_02_normal = pd.read_csv("C:\\Users\\sanid\\PycharmProjects\\Listen\\Listen_repo\\valve_csv\\valve_id_02_normal")
valve_id_04_abnormal = pd.read_csv("C:\\Users\\sanid\\PycharmProjects\\Listen\\Listen_repo\\valve_csv\\valve_id_04_abnormal")
valve_id_04_normal = pd.read_csv("C:\\Users\\sanid\\PycharmProjects\\Listen\\Listen_repo\\valve_csv\\valve_id_04_normal")
valve_id_06_abnormal = pd.read_csv("C:\\Users\\sanid\\PycharmProjects\\Listen\\Listen_repo\\valve_csv\\valve_id_06_abnormal")
valve_id_06_normal = pd.read_csv("C:\\Users\\sanid\\PycharmProjects\\Listen\\Listen_repo\\valve_csv\\valve_id_06_normal")
...
fan = pd.concat([fan_id04_abnormal,fan_id04_normal,fan_id02_abnormal,fan_id02_normal,fan_id06_abnormal,fan_id06_normal,fan_id00_abnormal,fan_id00_normal],ignore_index=True)
