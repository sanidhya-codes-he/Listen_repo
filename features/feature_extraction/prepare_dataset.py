...
sys.path.insert(0, str(Path(__file__).parent.parent))  # project root → finds config.py
sys.path.insert(0, str(Path(__file__).parent))          # feature_extraction → finds features.py
